...
4. 内部リンク用のキーワードを記事内に3〜5個含めること
   - 内部リンクは <a class="int-link" onclick="navigate('キーワード')">表示テキスト</a> 形式
5. infoboxには5〜7フィールドを含めること
6. 脚注は4〜6個、架空の書籍・論文・レポートから引用すること
7. カテゴリタグは3〜4個
8. 関連項目は3〜5個
9. 最終更新日時は「YYYY年M月D日 (嘘) HH:MM UTC」形式
10. 実在の人物・企業を否定的に描かないこと（肯定的・中立的な言及は可）
11. 文体は百科事典調（客観的、三人称、学術的）
...

{
  ...
  "sections": [
    {
      "heading": "セクション名",
      "content": "<p class=\\"wiki-p\\">HTMLテキスト（int-link、refを含む）</p>"
    }
  ],
  "footnotes": ["出典1", "出典2", ...],
  "categories": ["カテゴリ1", ...],
