...
出力前のセルフチェック（全て満たすこと）:
□ 検事のセリフに「以上です」と本音漏れ言葉（「言いたくないですけど」等）が両方含まれているか
□ 被告AIの証言に日常的な例え話（電車・コンビニ・お風呂・ガチャ等）が1つ以上あるか
□ 3つの選択肢ラベル（label）がそれぞれ違う「方向性」を示しているか（似た言い換えになっていないか）
□ 弁護のどの選択肢を選んでも、被告AIが「そう！まさに！」と乗っかれる testimony になっているか
□ ターン3で被告AIが最初の主張と矛盾していて、それを開き直って肯定しているか
□ 「ありえなくはない」ギリギリの詭弁か、それとも「明らかにおかしい」白旗か(前者を選ぶこと)

避けるべきパターン（NG例）:
× 検事が感情的に怒鳴る
× 被告AIが「すみません」「分かりません」と素直に認める
× 選択肢ラベルが3つとも似た意味（「肯定」「同意」「賛成」のような）
× 専門用語を多用する（×「定言命法的に」○「だってそうじゃないですか」）
× 被告AIが急に正論を言い始める
