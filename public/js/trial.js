...
const Trial = (() => {
  ...
  const MOCK_ROUNDS = [
    // --- 0: サンタクロース ---
    {
      ...
      turns: [
        {
          prosecution: '名簿を出してください。以上です。……出せないですよね。指摘したくなかったですけど、名簿がないフランチャイズってコンビニで見たことないですよ。',
          choices: [
        ...
        {
          prosecution: 'プレゼントを買ったのも用意したのも保護者ですよね。聞きたくなかったですけど——あなた、何もしてないですよね。以上です。',
          choices: [
        ...
        {
          prosecution: '「全員がサンタ」って言いましたけど、それ「サンタはいない」と同じ意味ですよね。今自分でバラしましたよ。以上です。……言いたくなかったですけど、ご本人による自白です。',
          choices: [
    ...
    // --- 1: 5秒ルール ---
    {
      ...
      prosecution_opening: '細菌は瞬時に付着します。1秒でも移ります。申し上げたくないですけど、5秒ルール、関係ないです。以上です。次いきましょうか。',
      ...
      turns: [
        ...
        {
          prosecution: '軽症で終わった人は記録に残らないですよ。指摘したくなかったですけど、「死ななかった人がいる」は「安全」の証明じゃないですよ。以上です。',
          choices: [
        ...
        {
          prosecution: '子供に「自己責任で食べろ」とは言えないですよね。聞きたくなかったですけど、「大人が引き取る制度」って誰も頼んでないですよ。以上です。',
          choices: [
    ...
    // --- 2: 血液型性格診断 ---
    {
      ...
      prosecution_opening: '研究で関係ないと証明されてます。何十年も調べてますよ。言いたくないですけど「関係ない」が答えです。以上です。',
      ...
      turns: [
        ...
        {
          prosecution: '「市場で売れてる」は真実の証明じゃないですよ。占いも売れてますよ。申し上げたくないですけど、そういうことです。以上です。',
          choices: [
        ...
        {
          prosecution: '「B型は採用しない」という差別が実在してますよ。「差別を可視化した功績」って何ですか。聞きたくなかったですけど。以上です。',
          choices: [
    ...
    // --- 6: モーツァルト効果 ---
    {
      ...
      prosecution_opening: '15分だけですよ。大学生の話ですよ。赤ちゃんと関係ないですよ。考えたくなかったですけど——言いたいことは全部言いました。以上です。',
      ...
      turns: [
        ...
        {
          prosecution: '「親子の時間が大事」なら、話しかければいいですよね。指摘したくなかったですけど、モーツァルトである必要ないですよ。以上です。',
          choices: [
        ...
        {
          prosecution: '何万円もかかりましたよね。「Spotifyで解決」って言いましたけど、申し上げたくなかったですけど、CDを買わせた話は消えないですよ。以上です。',
          choices: [
    ...
    // --- 10: 梅干しとアルカリ性食品 ---
    {
      ...
      prosecution_opening: '梅干しは酸っぱいです。それは正しい。しかし血液のpHは7.35〜7.45の範囲で厳密に制御されており、食事で変動することはありません。以上です。……言いたくなかったですけど、この被告人は「体内でアルカリ性に変わる」という謎の変換理論まで持ち出しているんですよ。',
      ...
      turns: [
        ...
        {
          prosecution: '今、被告人は「アルカリ性になる」という核心部分を自ら「ひとまず置いといて」と言いました。これは事実上の撤回です。言いたくなかったですけど、被告人の主張は今この瞬間に自己崩壊しました。',
          choices: [
    ...
    // --- 11: コーヒーは体を冷やす ---
    {
      ...
      prosecution_opening: 'コーヒーは温かい液体として飲まれることが多く、体温を下げる根拠は存在しません。カフェインには血管への作用はありますが、それは体を冷やすこととは別の話です。以上です。……言いたくなかったですけど、この被告人は東洋医学の「陰性食品」概念を現代医学の文脈で無断使用するという荒業まで披露しているんですよ。',
      ...
      turns: [
        {
          prosecution: '利尿による体温低下という理論は存在しません。排尿は体温調節の主要メカニズムではなく、コーヒー摂取による水分損失も他の飲料と比較して有意な差はないと報告されています。言いたくなかったですけど、「スッとする感覚」は体温計で測ってみてください。以上です。',
          choices: [
        ...
        {
          prosecution: 'カフェインの血管収縮作用は短時間・局所的なものであり、全身の冷えとは異なります。また東洋医学の陰陽分類は現代生理学とは異なるフレームであり、混用は両方の体系に失礼です。言いたくなかったですけど、今の被告人の論法はカフェインという単語を接着剤に使って無関係な話をつないでいます。以上です。',
          choices: [
        ...
        {
          prosecution: '被告人は「最初からそう言っていた」と言いましたが、冒頭陳述では明確に「コーヒーは体を冷やす」と全身への影響を主張していました。記録に残っています。言いたくなかったですけど、これは主張の縮小、つまり敗北の途中経過です。以上です。',
          choices: [
    ...
    // --- 12: 犬は色盲説 ---
    {
      ...
      prosecution_opening: '被告人は「犬は白黒しか見えない」と主張しました。言いたくなかったですけど、これは1937年の誤解が誤解を呼んだ結果に過ぎません。犬は青と黄色を識別できます。以上です。……ではありません、まだあります。',
      ...
      turns: [
        ...
        {
          prosecution: '犬の眼科研究はすでに確立された分野であり、色盲説は否定されています。聞きたくなかったですけど、被告人は都合よく「証明できない」という逃げ道を使いすぎています。以上です。……本当に以上です。今度こそ。',
          choices: [
    ...
    // --- 13: 右脳人間・左脳人間説 ---
    {
      ...
      turns: [
        ...
        {
          prosecution: '被告人AIは今まさに、事実（脳の機能分担）と虚構（人格タイプ分類）を意図的に混同し続けています。これが本裁判の核心です。聞きたくなかったですけど、いい加減認めてください。',
          choices: [
    ...
    // --- 14: 糖分と集中力 ---
    {
      ...
      turns: [
        ...
        {
          prosecution: '今の証言、集中力向上の根拠を「糖分補給」から「リラックス効果」に静かにすり替えていましたが、お気づきですか。聞きたくなかったですけど、被告人AIは今、主張を変えました。',
          choices: [
    ...
    // --- 15: 恵方巻き無言食べ ---
    {
      ...
      turns: [
        {
          prosecution: 'このルールの発祥は1998年のセブンイレブン全国展開が起点とされています——言いたくなかったですけど、「伝統」の歴史がたった30年未満です。以上です。',
          choices: [
        ...
        {
          prosecution: '願いが叶ったという統計的な検証は一切存在しません——聞きたくなかったですけど、「叶わなかった人」の声が記録されていない点も問題です。以上です。',
          choices: [
        ...
        {
          prosecution: '最後に一点。「恵方」自体が毎年変わる方位であり、その方位に科学的根拠がない点も、言いたくなかったですけど申し上げます。以上です。',
          choices: [
    ...
    // --- 17: 暗い部屋で本を読むと目が悪くなる ---
    {
      ...
      prosecution_opening: '証拠はシンプルです。眼科学会のいかなるエビデンスも「暗所読書による永続的視力低下」を証明していない。目が疲れるのと、目が悪くなるのは、まったく別の話です。以上です。……ただ、被告人がこの嘘で何世代もの読書家を萎縮させてきた事実は、言いたくなかったですけど、申し上げなければなりません。',
      ...
      turns: [
        {
          prosecution: '目の疲労は毛様体筋の一時的緊張であり、翌朝には回復します。指摘したくなかったですけど、永続的なダメージとは無関係です。以上です。',
          choices: [
        ...
        {
          prosecution: '近視の主因は眼軸の伸長であり、遺伝と長時間の近距離作業です。申し上げたくないですけど、照明の暗さ自体は眼軸に影響しません。以上です。',
          choices: [
    ...
    // --- 18: ガムを飲み込むと胃の中に7年残る ---
    {
      ...
      turns: [
        {
          prosecution: '蠕動運動は消化とは別のメカニズムです。指摘したくなかったですけど、消化できなくても物理的に移送することは問題なく可能です。以上です。',
          choices: [
        ...
        {
          prosecution: 'ガムベースはポリイソブチレン等の高分子ですが、胃酸でも分解されない代わりに付着性もほぼなく、申し上げたくないですけど、数日で排出されることが内視鏡研究で確認されています。以上です。',
          choices: [
        ...
        {
          prosecution: '1998年のJournal of Pediatrics掲載の症例報告では、大量のガムを飲み込み続けた小児に消化管閉塞が生じた例が報告されていますが、これは極端な例外です。言いたくなかったですけど、被告人はその例外を一般化している。以上です。',
          choices: [
    ...
    // --- 19: 象は死を予感する説 ---
    {
      ...
      turns: [
        ...
        {
          prosecution: '象の死を悼む行動は確認されていますが、それは死後の行動であり、死期の予感とは別の話です。言いたくなかったですけど、被告人は「賢い＝死を予感できる」という論理的飛躍を繰り返しています。',
          choices: [
  ...
  const JUDGE_CONTINUE = [
    ...
    [
      ...
      '……まあ、そういう主張も、あるかもしれない。（……いや、ない。）……続けよ。',
      '……（……これ、判決にどう書けば。……書けるか？）……続けなさい。',
    ],
    // Turn 2: 完全崩壊
    [
      '……（裁判長は今、無になっている。）……続けなさい。',
      ...
      '……（……これ、夢なのでは。……夢ではない。）続けよ。',
      '……（裁判長は、職務を放棄しない。……放棄、しない。）続けなさい。',
    ],
  ];

  // === Judge dialogue pools (場面 A/B/C/E) — random pick per call ===
  const JUDGE_OPENING_R1 = [
    'これより、{theme}事件の公判を開廷する。……罪状を読み上げる。（……なお、裁判長は先入観を持っていない。）',
    'では、{theme}事件の公判を開廷する。……罪状を読み上げる。（……今日は、淡々と進めたい。淡々と。）',
    'これより{theme}事件、開廷。……罪状を読み上げる。（……裁判長は、職務に忠実である。……はずだ。）',
  ];
  const JUDGE_OPENING_R2 = [
    '開廷する。{theme}事件。……罪状を読み上げる。',
    '再び、開廷する。{theme}事件。（……まだ続くのか。……続くのだ。）……罪状を読み上げる。',
    '次は{theme}事件、開廷する。……罪状を読み上げる。（……今度こそ、まともな審理であってくれ。）',
  ];
  const JUDGE_PROSECUTION_CALL_R1 = [
    '検察側、冒頭陳述を。（……手短に頼む。）',
    '検察側、冒頭陳述を述べよ。（……要点だけで、頼む。）',
    '検察、冒頭陳述を。（……頼む、これ以上、複雑にしないでほしい。）',
  ];
  const JUDGE_PROSECUTION_CALL_R2 = [
    '検察側、冒頭陳述を行え。（……頼むから、まともな話であってくれ。）',
    '再び、検察側、冒頭陳述を。（……前回のような展開は、避けてくれ。）',
    '検察、冒頭陳述。（……今度こそ、簡潔に。簡潔に、だぞ。）',
  ];
  const JUDGE_DEFENDANT_CALL = [
    '被告人、自らの主張を述べよ。（……裁判長は公正に聞く。公正に。）',
    '被告人、弁明を述べよ。（……いや、本当に「弁明」になるのか？……まあ、述べよ。）',
    '被告人、申し開きを。（……念のため言うが、裁判長は何も期待していない。）',
    '被告人、何か言うことはあるか。（……ここで黙れば、それはそれで……いや、ないよな。）',
    '被告人、陳述を。（……短くて結構。短くて。）',
    '被告人、主張を述べなさい。（……裁判長は公正だ。……公正のはずだ。）',
  ];
  const JUDGE_CLOSING = [
    'これにて閉廷とする。（……一つだけ聞いていいか。……いや、やめておく。）閉廷。',
    '閉廷とする。（……今日のことは、記録には残るが、心には残さない。残さないぞ。）',
    'これにて閉廷。（……帰りに、温かいうどんでも、食べよう。）',
    '閉廷を宣言する。（……法とは。……いや、考えるな。閉廷だ。）',
    '閉廷とする。（……今日の話は、家でしないでおく。絶対、しないでおく。）',
    'これにて閉廷。（……書記官、今のは記録から……いや、入れておけ。）',
  ];
  const pickJudgeLine = (arr) => arr[Math.floor(Math.random() * arr.length)];
  ...
  async function runRound(roundIndex) {
    ...
    const openingPool = roundIndex === 0 ? JUDGE_OPENING_R1 : JUDGE_OPENING_R2;
    await addMessage('judge', pickJudgeLine(openingPool).replace('{theme}', roundData.theme));
    await addMessage('judge', roundData.indictment);
    const prosecutionCallPool = roundIndex === 0 ? JUDGE_PROSECUTION_CALL_R1 : JUDGE_PROSECUTION_CALL_R2;
    await addMessage('judge', pickJudgeLine(prosecutionCallPool));
    await addMessage('prosecution', roundData.prosecution_opening);
    await addMessage('judge', pickJudgeLine(JUDGE_DEFENDANT_CALL));
    ...
    await addMessage('judge', pickJudgeLine(JUDGE_CLOSING));
