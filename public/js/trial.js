...
const Trial = (() => {
  ...
  const MOCK_ROUNDS = [
    ...
    // --- 11: コーヒーは体を冷やす ---
    {
      ...
      turns: [
        ...
        {
          prosecution: 'カフェインの血管収縮作用は短時間・局所的なものであり、全身の冷えとは異なります。また東洋医学の陰陽分類は現代生理学とは異なるフレームであり、混用は両方の体系に失礼です。言いたくなかったですけど、今の被告人の論法はカフェインという単語を接着剤に使って無関係な話をつないでいます。',
          choices: [
        ...
        {
          prosecution: '被告人は「最初からそう言っていた」と言いましたが、冒頭陳述では明確に「コーヒーは体を冷やす」と全身への影響を主張していました。記録に残っています。言いたくなかったですけど、これは主張の縮小、つまり敗北の途中経過です。',
          choices: [
  ...
  async function runRound(roundIndex) {
    ...
    await addMessage('judge', '被告人、自らの主張を述べよ。（……裁判長は公正に聞く。公正に。）');
